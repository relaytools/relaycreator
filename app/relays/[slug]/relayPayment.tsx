...
export default function RelayPayment(props: React.PropsWithChildren<{
        ...
        <div className="font-jetbrains">
            <div className="">
                <div className="flex">
                    <div className=" ">
                        <div>
                            <div className="text-lg">This relay requires payment of {props.relay.payment_amount} sats to post. ⚡</div>
                            {showPubkeyInput &&
