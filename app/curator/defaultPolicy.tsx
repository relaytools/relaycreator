        ...
        <div className="flex flex-col">
            <div className="">
                <label className={isAllow()} onClick={(e) => handleChange(e)} >
                    <div className="btn uppercase btn-primary swap-on">Default message policy: ALLOW ✅</div>
                    <div className="btn uppercase btn-primary swap-off">Default message policy: DENY 🔨</div>
                </label>
            </div>
            <div className="mt-4">
                <label className={isAllowKeywordPubkey()} onClick={(e) => handleAllowKeywordPubkey(e)} >
                    <div className="btn uppercase btn-primary swap-on">Additional Policy: Allow Pubkeys -AND REQUIRE- Keywords</div>
                    <div className="btn uppercase btn-primary swap-off">Additional Policy: Allow Pubkeys -OR- Keywords</div>
                </label>
            </div>
            <div className="mt-4">
                <label className={isListed()} onClick={(e) => handleListedChange(e)} >
                    <div className="btn uppercase btn-primary swap-on">Relay is listed in the public directory ✅</div>
                    <div className="btn uppercase btn-primary swap-off">Relay is NOT listed in the public directory 🙈</div>
                </label>
            </div>
            <div className="mt-4">
                <label className={isAuthRequired()} onClick={(e) => handleAuthChange(e)} >
                    <div className="btn uppercase btn-primary swap-on">Relay requires AUTH (NIP42) ✅</div>
                    <div className="btn uppercase btn-primary swap-off">Relay does not require AUTH (NIP42) 🙈</div>
                </label>
            </div>
            <div className="mt-4">
                <label className={isGiftwrap()} onClick={(e) => handleGiftwrapChange(e)} >
                    <div className="btn uppercase btn-primary swap-on">Allow Private Groups ✅</div>
                    <div className="btn uppercase btn-primary swap-off">Do NOT allow Private Groups 🙈</div>
                </label>
            </div>
            <div className="mt-4">
                <label className={isTagged()} onClick={(e) => handleTaggedChange(e)} >
                    <div className="btn uppercase btn-primary swap-on">Allow Events Tagged to Pubkeys ✅</div>
                    <div className="btn uppercase btn-primary swap-off">Do NOT Allow Events Tagged to Pubkeys 🙈</div>
                </label>
            </div>
            <div className="mt-4 flex">
                <label className={isPay()} onClick={(e) => handlePayChange(e)} >
                    <div className="btn uppercase btn-primary swap-on">Require lightning to post: on ⚡</div>
                    <div className="btn uppercase btn-primary swap-off">Require lightning to post: off</div>
                </label>
